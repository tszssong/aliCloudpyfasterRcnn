...
if __name__ == '__main__':
    ...
    caffemodel ="/nfs/zhengmeisong/wkspace/caffe_wk/py-faster-rcnn/output/faster_rcnn_end2end/voc_2007_trainval/mmcv5_gesture_iter_90000.caffemodel"
    if args.cpu_mode:
        caffe.set_mode_cpu()
    else:
        caffe.set_mode_gpu()
    ...
    listfile=open("/nfs/zhengmeisong/wkspace/caffe_wk/py-faster-rcnn/data/testlist.txt", "a+")
    for filename in os.listdir(r"/nfs/zhengmeisong/wkspace/caffe_wk/py-faster-rcnn/data/test/"):
        ...
        for cls_ind, cls in enumerate(CLASSES[1:]):
            ...
            listfile.write(filename+" 1 " + str(int(bbox[0])) +' '+str(int(bbox[1]))+' '+str(int(bbox[2]))+' '+str(int(bbox[3]))+'\n')
#            cv2.imwrite("/Users/momo/wkspace/Data/gesture/2018-04-01/zanVGG/"+filename, im);
